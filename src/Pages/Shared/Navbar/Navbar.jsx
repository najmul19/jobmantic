...
const Navbar = () => {
  return (
    <div className=" sticky top-0 z-50 navbar bg-gradient-to-r from-[#F8FBFF] via-[#D0EAFE]/40 to-[#E6E8FE] sm:px-8 md:px-16 lg:px-24 max-h-[130px]">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal  font-medium text-[14px]">
          <li>
      ...
      <div className="navbar-end gap-2 sm:gap-3">
        ...
        <div className="navbar-end gap-2  hidden lg:flex flex-row w-full ">
          {" "}
